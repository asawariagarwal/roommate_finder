class PreferencesController < ApplicationController
  ...
  def current_user_must_be_preference_user
    ...
    def preference_params
      params.require(:preference).permit(:user_id, :budget_max, :preferred_move_in, :unit_type, :cleanliness, :hosting, :neighborhood, :notes, :pet_friendly, :roommie_gender_preference)
    end
end
